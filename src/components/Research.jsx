      ...
      <Row>
        ...
        <Col md={8}>
          <Card>
            <Card.Body>
              <Card.Text>
                Study of electronic structure like distribution of states and spins is key
                in unerstanding nature of materials. For instance, all the materials predicted by our 
                neural networs and other computational approaches is a valid battery 
                material only if it has a band-gap. The analysis of electronic distribution is done 
                by various DFT calculations. 
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
